...
public:
    ...
    virtual void visitCallStmt(CallStmt *stmt)=0;
...
public:
    ...
    void visitCallStmt(CallStmt *stmt);
...
private:
    ...
    static std::unique_ptr<LiteralExpr> createIntLiteral(int value);
    static std::unique_ptr<LiteralExpr> createFloatLiteral(float value);
    static std::unique_ptr<LiteralExpr> createStringLiteral(const std::string &value);
    static std::unique_ptr<LiteralExpr> createBoolLiteral(bool value);
    static std::unique_ptr<LiteralExpr> createPointerLiteral(void *value);
